...
```
 ...
 Для загрузки модифицированного письма тоже используйте функцию `load(path)`.
 ...
 7. Проверьте, как себя поведёт новый классификатор на вашем модифицированном письме.
